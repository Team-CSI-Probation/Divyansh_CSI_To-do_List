window.addEventListener('load',() =>{
    const form = document.querySelector("#inside");
    ...
    form.addEventListener('submit',(e) => {
       ...
       task_mark_el.classList.add("InComplet");
       task_mark_el.innerHTML="InComplet";
       ...
       task_mark_el.addEventListener('click',()=>{
        if(task_mark_el.innerText=="Incomplete"){

        }
        else{
         task_mark_el.innerText="Completed";
        }
     });
